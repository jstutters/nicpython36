...
def load_options(default_config, user_config):
    ...
    options['model_1_train'] = (default_config.get('completed', 'model_1_train'))
    options['model_2_train'] = (default_config.get('completed', 'model_2_train'))
    options['pre_processing'] = (default_config.get('completed', 'pre_processing'))
