...
class wm_seg:
    ...
    def parameter_window(self):
        ...
        register_label.grid(row=1, sticky="W")
    ...
    def load_default_configuration(self):
        ...
        self.param_register_modalities_Kind.set(default_config.get('database', 'register_modalities_Kind'))
